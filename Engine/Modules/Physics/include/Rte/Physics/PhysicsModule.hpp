...
namespace Rte::Physics {
    ...
    class PhysicsModule : public IModule {
        public: // Overridden methods
            ...
            //[[nodiscard]] virtual std::shared_ptr<Sensor> createSensor(const Rte::Vec2<u16>& size, const Vec2<float>& pos, float rotation, ShapeType shapeType) = 0;
            ...
            virtual void setFriction(const std::shared_ptr<ShapeBody>& ShapeBody, float friction) = 0;
            ...
            [[nodiscard]] virtual Rte::Vec2<float> getVelocity(const std::shared_ptr<ShapeBody>& ShapeBody) const = 0;
            ...
            [[nodiscard]] virtual bool colliding(const std::shared_ptr<ShapeBody> &shapeBody, const std::shared_ptr<RigidBody> &rigidBody) const = 0;
    };
