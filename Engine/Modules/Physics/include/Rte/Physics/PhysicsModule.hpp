...
namespace Rte::Physics {
    ...
    class PhysicsModule : public IModule {
        public: // Overridden methods
            ...
            [[nodiscard]] virtual std::vector<Pixel> getSandBoxCanvas(std::shared_ptr<SandBox> sandBox) const = 0;
            [[nodiscard]] virtual std::vector<Particle> getSandBoxParticles(std::shared_ptr<SandBox> sandBox) const = 0;
            virtual void changeSandBoxPixel(Entity sandBox, Vec2<int> pos, Pixel pixel) = 0;
    };
